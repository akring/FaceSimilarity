...
//            faceInput1.rcFace = pFaceResFD->rcFace[0];
//            faceInput1.lOrient = pFaceResFD->lfaceOrient[0];
//
//            AFR_FSDK_FACEINPUT faceInput2 = {0};
//            faceInput2.rcFace = pFaceResFD->rcFace[1];
//            faceInput2.lOrient = pFaceResFD->lfaceOrient[1];
//
...
//                }
//
//                MFloat scoreThreshold = 0.56;//相似度阈值
